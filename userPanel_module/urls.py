...
from .views import AddNewArticle, AddNewReview_View, ProfessorLast_reviews_View,EditReview_View, showArticle, EditArticle
...
urlpatterns = [
    ...
    path('profile/edit_article/<str:article_id>', EditArticle.as_view(), name="edit_article"),
